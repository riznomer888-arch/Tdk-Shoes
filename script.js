...
 * Адаптировано под дизайн Vitkac: бренды, артикулы, статусы и галереи
 */
const PRODUCTS_DATA = [
    {
        id: 1,
        brand: "BALENCIAGA",
        name: "Jasnoniebieskie jeansy z szerokimi nogawkami", // Оригинальное название для аутентичности
        sku: "871354 TDW14-4200",
        category: "jeans",
        price: 601900, // Цена в тенге (601 900 ₸)
        installment: 25540, // Рассрочка в тенге
        images: ["jeans_front.jpg", "jeans_model.jpg", "jeans_back.jpg"],
        sizes: { "29": 1, "30": 3, "31": 0 },
        badge: "OSTATNIA SZTUKA" // "Остался последний" на польском для стиля, либо замените на "ПОСЛЕДНИЙ РАЗМЕР"
    },
    {
        id: 2,
        brand: "BALENCIAGA",
...
        price: 1420000,
        installment: 60310,
        images: ["bag_black_1.jpg", "bag_black_2.jpg"],
        sizes: { "UNI": 2 },
        badge: null
    },
    {
...
        price: 1115000,
        installment: 47380,
        images: ["bag_pink_1.jpg"],
        sizes: { "UNI": 0 }, 
        badge: "WYPRZEDANE" // "Распродано"
    }
];
...
 * Минималистичная сетка Vitkac: чистые шрифты, аккуратная кнопка лайка и скрытые границы
 */
...
/**
 * ОТКРЫТИЕ МОДАЛЬНОГО ОКНА (Правая панель, как на скриншоте 3)
 */
...
// Листалка фото в карточке товара
...
/**
 * ОТПРАВКА КОРРЕКТНЫХ ДАННЫХ В TELEGRAM-БОТ
 */
...
        // Аккуратный премиальный чек для менеджера
        const message = `
...
        });
    });
}); вот код кароче ща скажу что делать
